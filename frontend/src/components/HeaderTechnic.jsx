...
const Header = () => {
  return (
    <header className="flex items-center justify-between whitespace-nowrap bg-white px-6 md:px-10 py-4 shadow-sm z-10 relative">
      <div className="flex items-center gap-4 text-slate-900">
        ...
        <div>
          <h2 className="text-slate-900 text-lg font-bold leading-tight tracking-tight">MADARA</h2>
      ...
      <div className="flex flex-1 justify-end gap-8 items-center">
        <nav className="hidden md:flex items-center gap-8">
          ...
          <NavLink 
            ...
            className={({ isActive }) => 
              isActive ? "text-[#f97415] text-sm font-bold" : "text-slate-500 hover:text-[#f97415] text-sm font-medium transition-colors"
            }
          >
            Comptes
          </NavLink>
        ...
        <div className="flex gap-3 items-center pl-6 border-l border-slate-100">
          ...
          <div 
            ...
            style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuAzZlyXt-I8MGrkWNmogG09uJp2dplPRglKK1k6IrLRwc9k0IxrSi1s9vVAgeD2Z1KdkskRhmKeKtM_nPnpLRQtSiN837B3-MgjoyOuA200w1V7hOeIuf8GbpEn09ZvHUbseCqy6jz5FtvAFVizv816m2ymWnqmgB3sKFbE_z_W_FOP4-CkiHgxbersmVSjElySBGS6EK6KW-IiXeULsuIc1raU26a0rcYPmA425DktQCZRBzAJcmxKm-NljxjZLTLTVDI6Yz9Rjdc")' }}
          ></div>
        </div>
      </div>
    </header>
